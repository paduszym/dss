...
class CAdESLevelTAddASN1EvidenceRecordWithHashtreeTest extends AbstractCAdESAddEvidenceRecordTest {
    ...
    protected DSSDocument getEvidenceRecordDocument() {
        return new InMemoryDocument(CAdESLevelLTAddASN1EvidenceRecordTest.class.getResourceAsStream(
                "/validation/evidence-record/CAdEs-BpT-with-reducedHashTree.ers"));
    }
