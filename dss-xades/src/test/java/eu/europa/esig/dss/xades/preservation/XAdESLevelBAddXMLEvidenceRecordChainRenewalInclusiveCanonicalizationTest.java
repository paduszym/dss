...
class XAdESLevelBAddXMLEvidenceRecordChainRenewalInclusiveCanonicalizationTest extends AbstractXAdESAddEvidenceRecordTest {
    ...
    protected DSSDocument getEvidenceRecordDocument() {
        return new FileDocument("src/test/resources/validation/evidence-record/incorporation/evidence-record-XAdES-B-inclusive.xml");
    }
    ...
    public void addERAndValidate() {
        ...
        assertTrue(exception.getMessage().contains("Error on evidence record incorporation : Broken timestamp(s) detected."));

        // The ER is computed using the following namespace prefix
